...
public class quiz extends JFrame implements ActionListener{
    ...
    quiz(String name){
        ...
        setLayout(null);
        ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("icons/quizquestion.png"));
        JLabel image= new JLabel(i1);
        image.setBounds(0,0,1500,400);
        add(image);
        
        qno= new JLabel();
        qno.setBounds(200,450,50,25);
        qno.setFont(new Font("Times New Roman",Font.PLAIN,30));
        qno.setForeground(Color.PINK);
        add(qno);
          
        question= new JLabel();
        question.setBounds(250,450,1100,33);
        question.setFont(new Font("Times New Roman",Font.PLAIN,30));
        question.setForeground(Color.PINK);
        add(question);
        
        opt1= new JRadioButton();
        opt1.setBounds(250,530, 800,25);
        opt1.setFont(new Font("Times New Roman",Font.PLAIN, 25));
        opt1.setForeground(Color.PINK);
        opt1.setBackground(Color.BLACK);
        add(opt1);
        
        opt2= new JRadioButton();
        opt2.setBounds(250,580, 800,25);
       ...
       lifeline.setBounds(1100,560,140,35);
       lifeline.setFont(new Font("Times New Roman",Font.PLAIN,25));
       ...
       next.setBounds(1100,620,140,35);
       ...
       submit.setBounds(1100,680,140,35);
    ...
    public void paint(Graphics g){
        ...
        if(Timer>0){
            g.drawString(time, 1060,550);
        }else{
            g.drawString("Time's up!", 1060, 550);
        }
        Timer--;
